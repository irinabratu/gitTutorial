public class Logic1 {
    ...
    public boolean old35(int n) {
        int resultT = n % 3;
        int resultN = n % 5;
        if ((resultT == 0 && resultN > 0) || (resultT > 0 && resultN == 0)) {
            return true;
        } else return false;
    }
    ...
    public String fizzString(String str) {
        boolean fCondition = str.substring(0, 1).equals("f");
        boolean bCondition = str.substring(str.length() - 1, str.length()).equals("b");
        if (fCondition && bCondition) {
            return "FizzBuzz";
        } else if (fCondition && !bCondition) {
            return "Fizz";
        } else if (!fCondition && bCondition) {
            return "Buzz";
        } else return str;
    ...
    public boolean lastDigit(int a, int b, int c) {
        ...
        int bRem = b % 10;
        int cRem = c % 10;
        if ((aRem == bRem) || (bRem == cRem) || (aRem == cRem) || (aRem == bRem && bRem == cRem)) {
            return true;
        } else return false;
    }
    ...
    public int sumLimit(int a, int b) {
        ...
        String bLen = String.valueOf(b);
        String abLen = String.valueOf(a+b);

        if (abLen.length() == aLen.length()) {
            return a+b;
        } else if (abLen.length() > aLen.length()) {
            return a;
        }
        return 0;
    }
